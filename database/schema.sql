...
CREATE TABLE IF NOT EXISTS prestamos (
    ...
    lectura_publica TINYINT(1) NOT NULL DEFAULT 0,
    lectura_fuente VARCHAR(40) NULL,
    lectura_id_externo VARCHAR(120) NULL,
    lectura_url VARCHAR(700) NULL,
    lectura_formato VARCHAR(80) NULL,
    pagina_lectura_actual INT UNSIGNED NOT NULL DEFAULT 1,
...
CREATE UNIQUE INDEX ux_usuarios_restablecimiento_token_hash ON usuarios_restablecimiento_contrasena(token_hash);
CREATE INDEX idx_usuarios_restablecimiento_usuario ON usuarios_restablecimiento_contrasena(id_usuario);
CREATE INDEX idx_usuarios_restablecimiento_expiracion ON usuarios_restablecimiento_contrasena(fecha_expiracion);
